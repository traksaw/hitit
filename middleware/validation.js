...
const validateFileUpload = (allowedTypes, maxSizeMB = 50) => {
  return (req, res, next) => {
    ...
    const allowedMimeTypes = {
      audio: ['audio/mpeg', 'audio/mp3', 'audio/wav', 'audio/wave', 'audio/x-wav', 'audio/mp4', 'audio/x-m4a'],
      image: ['image/jpeg', 'image/jpg', 'image/png', 'image/webp'],
      all: ['audio/mpeg', 'audio/mp3', 'audio/wav', 'audio/wave', 'audio/x-wav', 'audio/mp4', 'audio/x-m4a', 'image/jpeg', 'image/jpg', 'image/png', 'image/webp']
    };
